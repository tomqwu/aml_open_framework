...
> **Round 37 — Research archive completion + live deadline refresh** (`docs`, 2026-06-09):
>
...
> - **`docs/research/2026-06-regulator-pulse.md` updated** — the June 9 Effectiveness NPRM + GENIUS Act NPRM entry changed from `⚠️` (5 days remain) to `✓ COMMENT WINDOW CLOSED`. The "What MLROs need to do" rewritten to post-deadline language (complete gap analysis now; the 12-month clock starts at the final rule). The page's "Last updated" date and remaining countdowns were synced to the same 2026-06-09 as-of (AUSTRAC Tranche 2 22d, AMLA RTS 31d) so the whole page reads from one date, not a mix. No fabricated outcomes asserted — rulemaking remains pending.
> - **`docs/index.md` deadline countdown updated** — researcher/regulator card now reads "as of 2026-06-09": NPRM windows closed today, AUSTRAC Tranche 2 22 days, AMLA RTS 31 days, SR 26-2 53 days examination-active. Full research archive noted (20 editions). Round 37 What's-new row added. Card CTA retargeted from the July to the June regulator-pulse so the click-through lands on copy matching the card's June-9 figures.
...
> - **Three GitHub roadmap issues filed**: #538 (August 2026 research refresh prep), #539 (`aml sr26-2-examination-report` CLI — SR 26-2 53 days in, examination-active), #540 (AMLA direct-supervision selection exercise data pack — July 10 companion to #528). Codex review of this PR also filed #548 (artifact-map CLI/module accuracy across all data-problem editions — pre-existing template debt).
>
