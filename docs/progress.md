...
> - **`docs/index.md` deadline countdown updated** — researcher/regulator card now reads "as of 2026-06-09": NPRM windows closed today, AUSTRAC Tranche 2 22 days, AMLA RTS 31 days, SR 26-2 53 days examination-active. Full research archive noted (20 editions). Round 37 What's-new row added.
