...
> **Last updated 2026-07-08.** *Previous edition: [2026-06-regulator-pulse.md](2026-06-regulator-pulse.md). Full chronological log: [2026-05-regulator-pulse.md](2026-05-regulator-pulse.md) — 120 days, 33 events.*
...
### ✓ ENFORCEMENT LIVE · 2026-07-01 · AUSTRAC — Tranche 2 enforcement began for Australian DNFBPs (live since July 1)

**What it is:** AUSTRAC's Tranche 2 AML/CTF reform brought Australian lawyers, accountants, real-estate agents, and dealers in precious metals and stones (DPMS) under the AML/CTF Act with mandatory enrolment and board-approved AML/CTF programs. **Enforcement became effective 2026-07-01 — 7 days ago.**

**What MLROs need to do now that enforcement is live:**
- Australian DNFBPs not yet enrolled with AUSTRAC and without a documented, board-approved AML/CTF program are now in breach. AUSTRAC's stated first-cycle posture favours enforceable undertakings (EUs) over fines — but only for firms with documented good-faith compliance efforts. A board-approved program, even a lean one, is the difference between an EU and an immediate penalty. Firms that had one in place before July 1 entered the first cycle inside that favourable posture.
- DNFBPs that missed the July 1 deadline should treat the next 30 days as their window to document the program before AUSTRAC's first enforcement correspondence is issued. Documented action beats absence.
...
**What it is:** AMLA must submit final draft regulatory technical standards — including the CDD RTS (AMLR Article 28(1)), the business-relationships and occasional/linked-transactions RTS (AMLR Article 19(9)), and the pecuniary-sanctions RTS (AMLD6 Article 53(10)) — to the European Commission by July 10. After submission, the Commission has three months to endorse before the RTS become binding law. **2 days remain.**
...
- Institutions operating cross-border EU programs should complete their alignment-gap assessment before the Commission adoption clock starts — there are 2 days left before the standard is submitted.
...
These directly address the SR 26-2 and Effectiveness NPRM controls that are now examination-active (**82 days from April 17 as of July 8**): demonstrable test coverage of ML scoring logic, deterministic replay of flagged alerts, and a model inventory that can be produced on demand.
...
*Last updated: 2026-07-08 · Previous edition: [2026-06-regulator-pulse.md](2026-06-regulator-pulse.md). Full chronological log: [2026-05-regulator-pulse.md](2026-05-regulator-pulse.md) — 2026-02-01 → 2026-05-31, 120 days, 33 events.*
