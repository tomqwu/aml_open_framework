...
**What it is:** AMLA must submit final draft regulatory technical standards — including the CDD RTS (AMLR Article 28(1)), the ongoing-monitoring RTS (AMLR Article 26), and the targeted-financial-sanctions RTS (AMLR Article 20(1)(d)) — to the European Commission by July 10. After submission, the Commission has three months to endorse before the RTS become binding law. **9 days remain.**
