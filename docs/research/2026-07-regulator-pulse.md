...
### ✓ ENFORCEMENT LIVE · 2026-07-01 · AUSTRAC — Tranche 2 now active for Australian DNFBPs

**What it is:** AUSTRAC's Tranche 2 AML/CTF reform brought Australian lawyers, accountants, real-estate agents, and dealers in precious metals and stones (DPMS) under the AML/CTF Act with mandatory enrolment and board-approved AML/CTF programs. **Enforcement has been live since 2026-07-01 — 7 days ago.**

**What MLROs need to do now that enforcement is active:**
- Australian DNFBPs that are not yet enrolled with AUSTRAC or that lack a documented, board-approved AML/CTF program are in breach as of July 1. Enrol immediately and document good-faith remediation steps.
- AUSTRAC's stated first-cycle posture still favours enforceable undertakings (EUs) over immediate fines — but only for firms that can demonstrate documented good-faith compliance efforts. The difference between an EU and a penalty is now the quality of your remediation evidence, not your implementation timeline.
...
**What it is:** AMLA must submit final draft regulatory technical standards — including the CDD RTS (AMLR Article 28(1)), the business-relationships and occasional/linked-transactions RTS (AMLR Article 19(9)), and the pecuniary-sanctions RTS (AMLD6 Article 53(10)) — to the European Commission by July 10. After submission, the Commission has three months to endorse before the RTS become binding law. **2 days remain — deadline is 2026-07-10.**

**What MLROs need to do (deadline in 2 days):**
- EU-supervised obliged entities must treat July 10 as the "locked-in" date for the RTS framework — **this is the final 48-hour window**. Post-July amendments require a full new legislative cycle. Complete any outstanding alignment-gap assessment immediately.
- Institutions operating cross-border EU programs should finalise their gap assessment and brief compliance leadership before July 10 so the Commission adoption clock starts with your gaps already documented.
- Cross-border groups operating in 6+ member states should ensure data submissions for the AMLA 2027 direct-supervision selection exercise are complete — this exercise uses the same data period as the RTS.
