...
### 🚨 2026-07-01 · AUSTRAC — Tranche 2 enforcement begins for Australian DNFBPs (TODAY)
...
- Australian DNFBPs must be enrolled with AUSTRAC and have a documented, board-approved AML/CTF program as of July 1 (today). The enrolment-and-program obligation is live as of today.
- AUSTRAC's stated first-cycle posture favours enforceable undertakings (EUs) over fines — but only for firms with documented good-faith compliance efforts. A board-approved program, even a lean one, is the difference between an EU and an immediate penalty. Firms that had one ready before today enter the first cycle inside that favourable posture.
...
**What it is:** AMLA must submit final draft regulatory technical standards — including the CDD RTS (AMLR Article 28(1)), the business-relationships and occasional/linked-transactions RTS (AMLR Article 19(9)), and the pecuniary-sanctions RTS (AMLD6 Article 53(10)) — to the European Commission by July 10. After submission, the Commission has three months to endorse before the RTS become binding law. **9 days remain.**
