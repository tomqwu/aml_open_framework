...
> **Last updated 2026-07-09.** *Previous edition: [2026-06-regulator-pulse.md](2026-06-regulator-pulse.md). Full chronological log: [2026-05-regulator-pulse.md](2026-05-regulator-pulse.md) — 120 days, 33 events.*
...
### ✅ 2026-07-01 · AUSTRAC — Tranche 2 enforcement began for Australian DNFBPs (8 days ago — 2026-07-01)

**What it is:** AUSTRAC's Tranche 2 AML/CTF reform brings Australian lawyers, accountants, real-estate agents, and dealers in precious metals and stones (DPMS) under the AML/CTF Act with mandatory enrolment and board-approved AML/CTF programs, **enforceable from 2026-07-01 — now in effect (8 days ago).**

**What MLROs need to do:**
- Australian DNFBPs must be enrolled with AUSTRAC and have a documented, board-approved AML/CTF program as of July 1 (8 days ago). The enrolment-and-program obligation is now live.
- AUSTRAC's stated first-cycle posture favours enforceable undertakings (EUs) over fines — but only for firms with documented good-faith compliance efforts. A board-approved program, even a lean one, is the difference between an EU and an immediate penalty. Firms that had one ready before July 1 entered the first cycle inside that favourable posture; firms still assembling one now are outside it.
...
**What it is:** AMLA must submit final draft regulatory technical standards — including the CDD RTS (AMLR Article 28(1)), the ongoing-monitoring-of-business-relationship RTS (AMLR Article 26), and the targeted-financial-sanctions-screening RTS (AMLR Article 20(1)(d)) — to the European Commission by July 10. After submission, the Commission has three months to endorse before the RTS become binding law. **1 day remains.** *(Article numbers corrected 2026-07-09 — verified against EUR-Lex; the previously cited AMLR Art. 19(9) / AMLD6 Art. 53(10) were wrong. See CLAUDE.md #528.)*
...
- Institutions operating cross-border EU programs should complete their alignment-gap assessment before the Commission adoption clock starts — there is 1 day left before the standard is submitted.
...
These directly address the SR 26-2 and Effectiveness NPRM controls that are now examination-active (**83 days from April 17 as of July 9**): demonstrable test coverage of ML scoring logic, deterministic replay of flagged alerts, and a model inventory that can be produced on demand.
...
*Last updated: 2026-06-22 · Previous edition: [2026-06-regulator-pulse.md](2026-06-regulator-pulse.md). Full chronological log: [2026-05-regulator-pulse.md](2026-05-regulator-pulse.md) — 2026-02-01 → 2026-05-31, 120 days, 33 events.*
