...
*Date: 2026-08-13 · Audience: FinTech / EMI / MSB / VASP MLRO. Companion to [`2026-07-aml-process-pain.md`](2026-07-aml-process-pain.md) (Tier-1 bank lens). Previous edition: [`2026-06-fintech-aml-reality.md`](./2026-06-fintech-aml-reality.md).*
...
2. **The sponsor bank is a regulator-by-proxy.** After Synapse's April 2024 collapse and the cascade of Federal Reserve / OCC / FDIC consent orders, the sponsor bank's risk officer can move faster than any government regulator. With SR 26-2 118 days active, sponsor-bank third-party risk reviews now apply an MRM lens to fintech AML programs.
...
| | |
|---|---|
| **Plain-English description** | Australian lawyers, accountants, real-estate agents, and dealers in precious metals and stones became enforceable under the AML/CTF Act on **July 1, 2026 — 43 days ago**. Newly regulated entities that had not enrolled by go-live were required to enrol with AUSTRAC by **July 29, 2026 — now 15 days past**. AUSTRAC's stated first-cycle posture is enforceable undertakings rather than fines — but only for firms with documented, board-approved programs in place before July 1. Firms without one are now exposed, not counting down to exposure. |
...
For a fintech MLRO as of August 13, **the operative regulator is still whoever moves fastest** — but the two comment windows that defined June's urgency have closed, and both structural AUSTRAC obligations have now landed. The GENIUS Act NPRM comment window closed June 9: stablecoin issuers and their sponsor banks who engaged hold proactive-posture evidence; those who deferred still have to build what the pending final rule will require. AUSTRAC Tranche 2 enforcement **took effect July 1** (43 days ago), and the enrolment grace period for newly regulated entities **passed July 29 (15 days ago)**: Australian DNFBPs without a board-approved program are already exposed, not counting down to exposure. The AMLA RTS standard's submission deadline **passed July 10 (34 days ago)**: EU fintechs that haven't completed an alignment gap assessment are now working against a locked standard, not a moving target. In all three cases, the operative question is unchanged: **can you prove what you have?**
