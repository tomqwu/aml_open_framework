...
2. **AUSTRAC Tranche 2 enforcement is effective today (July 1).** Australian DNFBPs (lawyers, accountants, real-estate agents, DPMS) that do not have a board-approved AML/CTF program and AUSTRAC enrolment as of July 1 face enforceable consequences. AUSTRAC's stated first-cycle posture favours enforceable undertakings over fines — but only for firms with documented good-faith programs. For fintechs with Australian operations, the obligation is live today. FINTECH-10 has moved from "9 days" to "effective today."
...
4. **AMLA RTS final submission deadline is July 10 — 9 days.** AMLA must submit final draft regulatory technical standards to the European Commission by July 10. After submission the Commission has three months to endorse before the RTS become binding law. For EU fintechs, the alignment window is closing — the standard locks in 9 days, and gaps against the final RTS become implementation backlogs. FINTECH-6 urgency is increasing.

The 8 realities from May plus the 2 added in June (FINTECH-9 and FINTECH-10) remain valid. As of July 1, FINTECH-9 is "comment window closed," FINTECH-10 is "effective today," and FINTECH-6 is 9 days to AMLA RTS lock-in.
...
### FINTECH-10 · "AUSTRAC just made us an obliged entity — enforcement is effective today."

| | |
|---|---|
| **Plain-English description** | Australian lawyers, accountants, real-estate agents, and dealers in precious metals and stones become enforceable under the AML/CTF Act on **July 1, 2026 — effective today**. AUSTRAC's stated first-cycle posture is enforceable undertakings rather than fines — but only for firms with documented, board-approved programs in place before July 1. Programs stood up before today are inside the favourable posture at enforcement day. |
...
For a fintech MLRO as of July 1, **the operative regulator is still whoever moves fastest** — but the two comment windows that defined June's urgency have closed, and one structural obligation just arrived. The GENIUS Act NPRM comment window closed June 9: stablecoin issuers and their sponsor banks who engaged hold proactive-posture evidence; those who deferred still have to build what the pending final rule will require. AUSTRAC Tranche 2 enforcement is **effective today** (July 1): Australian DNFBPs without a board-approved program face enforceable consequences from today onward. The AMLA RTS standard locks in July 10 (**9 days**): EU fintechs that haven't completed an alignment gap assessment are building on a moving target. In all three cases, the operative question is unchanged: **can you prove what you have?**
