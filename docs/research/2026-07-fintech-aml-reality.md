...
*Date: 2026-07-17 · Audience: FinTech / EMI / MSB / VASP MLRO. Companion to [`2026-07-aml-process-pain.md`](2026-07-aml-process-pain.md) (Tier-1 bank lens). Previous edition: [`2026-06-fintech-aml-reality.md`](./2026-06-fintech-aml-reality.md).*
...
2. **AUSTRAC Tranche 2 enforcement is now live (16 days in, since July 1).** Australian DNFBPs (lawyers, accountants, real-estate agents, DPMS) must now have a board-approved AML/CTF program in place; AUSTRAC enrolment for the ~80,000–90,000 newly regulated entities remains open through 2026-07-29 (12 days). AUSTRAC's stated first-cycle posture is to prioritise enforcement against firms that wilfully ignore obligations, not first-cycle good-faith gaps — but civil penalties still reach A$31.3M per contravention. For fintechs with Australian operations, the program obligation is no longer a countdown — it is live. FINTECH-10 has moved from "9 days" to "in force."

3. **SR 26-2 is 91 days examination-active.** FinTech MLROs who manage transaction monitoring scenarios or CDD scoring models are in scope. Q2 2026 examination cycles have run and Q3 cycles are forming. Sponsor banks conducting third-party risk reviews of fintech AML programs are applying the same SR 26-2 MRM lens — the "independent challenger" requirement extends to in-house ML-based AML models in fintech programs reviewed as part of BaaS third-party risk management. The `aml model-inventory` CLI (v0.1.47) produces the SR 26-2 model-population inventory on demand — the artifact sponsor-bank MRM reviewers are now requesting.

4. **AMLA RTS final submission deadline has passed (July 10, 7 days ago).** AMLA was required to submit final draft regulatory technical standards to the European Commission by July 10; no public confirmation of submission has surfaced as of this edition. After submission the Commission has three months to endorse before the RTS become binding law. For EU fintechs, the standard is presumed locked regardless of confirmation, and gaps against the final RTS become implementation backlogs. FINTECH-6 urgency is unchanged — the window to influence the standard is now closed either way.

The 8 realities from May plus the 2 added in June (FINTECH-9 and FINTECH-10) remain valid. As of July 17, FINTECH-9 is "comment window closed, rulemaking pending," FINTECH-10 is "enforcement live, enrolment closes July 29," and FINTECH-6 is "AMLA RTS submission deadline passed."
...
2. **The sponsor bank is a regulator-by-proxy.** After Synapse's April 2024 collapse and the cascade of Federal Reserve / OCC / FDIC consent orders, the sponsor bank's risk officer can move faster than any government regulator. With SR 26-2 91 days active, sponsor-bank third-party risk reviews now apply an MRM lens to fintech AML programs.
...
| | |
|---|---|
| **Plain-English description** | EU Anti-Money Laundering Regulation 2024/1624 applies directly across all 27 Member States from 10 July 2027. AMLA's RTS consultations closed May 8, 2026 — AMLA was required to submit final draft RTS to the European Commission by **July 10, 2026, a deadline that passed 7 days ago** with no public confirmation of submission yet published. After submission, the Commission has three months to endorse before the RTS become binding law. EU fintechs should treat the standard as locked regardless of confirmation status. Gaps against the final RTS become implementation backlogs that compress the already-tight runway to July 2027. |
...
| **Primary source** | FinCEN + OFAC joint NPRM: *"Permitted Payment Stablecoin Issuers AML/CFT Programs and Sanctions Compliance Programs,"* Federal Register 2026-06963, published April 10, 2026. Proposes adding PPSIs as "financial institutions" under 31 U.S.C. § 5312(a)(2), requiring full BSA-program equivalents plus a mandatory OFAC sanctions compliance program under new 31 CFR Part 502. Banks sponsoring PPSIs must update their BSA/AML third-party risk assessments. **Comment window closed 2026-06-09; rulemaking pending.** — [Federal Register 2026-06963](https://www.federalregister.gov/documents/2026/04/10/2026-06963/permitted-payment-stablecoin-issuer-anti-money-launderingcountering-the-financing-of-terrorism); [Treasury Press Release SB0435](https://home.treasury.gov/news/press-releases/sb0435); [FinCEN PPSI NPRM PDF](https://www.fincen.gov/system/files/2026-04/PPSI-AMLCFT-NPRM.pdf). |
...
### FINTECH-10 · "AUSTRAC just made us an obliged entity — enforcement is now live."

| | |
|---|---|
| **Plain-English description** | Australian lawyers, accountants, real-estate agents, and dealers in precious metals and stones became enforceable under the AML/CTF Act on **July 1, 2026 — now 16 days in**. AUSTRAC enrolment itself stays open through **2026-07-29** for the ~80,000–90,000 newly regulated entities. AUSTRAC's stated first-cycle posture is to prioritise enforcement against firms that wilfully ignore obligations, not firms with documented, good-faith programs in place. Civil penalties still reach A$31.3M per contravention for a corporation. |
| **Vignette** | The managing partner of a Melbourne property conveyancing firm returns from a compliance conference and asks the operations manager: *"What's our AML/CTF program?"* The operations manager has a PEP check and a file note. AUSTRAC wants an enrolment, a board-approved program, a risk assessment, and compliance reports — the program obligation has been live since July 1, and enrolment closes July 29. |
| **Primary source** | AUSTRAC Regulatory Expectations and Priorities 2025–26: Tranche 2 reform brings lawyers, accountants, real-estate agents, and DPMS under the AML/CTF Act with mandatory enrolment and board-approved programs enforceable from **2026-07-01**; enrolment and AML/CTF-compliance-officer notification remain open through **2026-07-29**. AUSTRAC's stated posture favours enforceable undertakings over fines in the first cycle — but only for firms with documented, good-faith compliance efforts. — [AUSTRAC: Regulatory expectations 2025–26](https://www.austrac.gov.au/amlctf-reform/austrac-regulatory-expectations-and-priorities-2025-26); [AUSTRAC AML/CTF Reform hub](https://www.austrac.gov.au/amlctf-reform); [AUSTRAC: AML/CTF transitional rules 2026](https://www.austrac.gov.au/about-us/legislation/updates-legislation/amlctf-transitional-rules-2026). |
...
For a fintech MLRO as of July 17, **the operative regulator is still whoever moves fastest** — but the two comment windows that defined June's urgency have closed, and the two structural obligations that were imminent have themselves now arrived. The GENIUS Act NPRM comment window closed June 9: stablecoin issuers and their sponsor banks who engaged hold proactive-posture evidence; those who deferred still have to build what the pending final rule will require. AUSTRAC Tranche 2 enforcement is **now live** (July 1, 16 days in; enrolment closes July 29): Australian DNFBPs without a board-approved program are already exposed. The AMLA RTS submission deadline (July 10) **has passed** (7 days ago): EU fintechs that haven't completed an alignment gap assessment are building against a standard that is presumed locked. In all three cases, the operative question is unchanged: **can you prove what you have?**
...
- [AUSTRAC: AML/CTF transitional rules 2026 (enrolment + compliance-officer notification to 2026-07-29)](https://www.austrac.gov.au/about-us/legislation/updates-legislation/amlctf-transitional-rules-2026)
