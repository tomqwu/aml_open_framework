...
*Date: 2026-08-17 · Audience: FinTech / EMI / MSB / VASP MLRO. Companion to [`2026-07-aml-process-pain.md`](2026-07-aml-process-pain.md) (Tier-1 bank lens). Previous edition: [`2026-06-fintech-aml-reality.md`](./2026-06-fintech-aml-reality.md).*
...
2. **The sponsor bank is a regulator-by-proxy.** After Synapse's April 2024 collapse and the cascade of Federal Reserve / OCC / FDIC consent orders, the sponsor bank's risk officer can move faster than any government regulator. With SR 26-2 122 days active, sponsor-bank third-party risk reviews now apply an MRM lens to fintech AML programs.
...
| | |
|---|---|
| **Plain-English description** | Australian lawyers, accountants, real-estate agents, and dealers in precious metals and stones became enforceable under the AML/CTF Act on **July 1, 2026 — 47 days ago**. Newly regulated entities that had not enrolled by go-live were required to enrol with AUSTRAC by **July 29, 2026 — now 19 days past**. AUSTRAC's stated first-cycle posture is enforceable undertakings rather than fines — but only for firms with documented, board-approved programs in place before July 1. Firms without one are now exposed, not counting down to exposure. |
