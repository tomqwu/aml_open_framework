...
> **Last updated 2026-06-08.** *Full chronological log: [2026-05-regulator-pulse.md](2026-05-regulator-pulse.md) — 120 days, 33 events. Previous edition: [2026-04-regulator-pulse.md](2026-04-regulator-pulse.md) — 89 days, 30 events.*
...
**What it is:** Two major NPRMs share a single comment deadline. **TOMORROW. 1 day remains.**
...
**What MLROs need to do by June 9 (TOMORROW):**
- **Complete gap analyses now.** Monday June 8 is the final business day before the Tuesday June 9 deadline for most firms. Comment letters must be filed or submitted **today**.
...
**What it is:** AUSTRAC's Tranche 2 AML/CTF reform brings Australian lawyers, accountants, real-estate agents, and dealers in precious metals and stones (DPMS) under the AML/CTF Act with mandatory enrolment and board-approved AML/CTF programs, enforceable from 2026-07-01. **23 days remain.**
...
**What it is:** AMLA must submit final draft regulatory technical standards — including the CDD RTS (AMLR Article 28(1)), the business-relationships and occasional/linked-transactions RTS (Article 19(9)), and the pecuniary-sanctions RTS (AMLD6 Article 53(10)) — to the European Commission by July 10. After submission, the Commission has three months to endorse before the RTS become binding law. **32 days remain.**
...
| **GENIUS PPSI compliance templates** (`genius_ppsi_issuer` + `genius_ppsi_stablecoin`) | v0.1.47 | GENIUS Act s.4 + NPRM FR 2026-06963 — BSA-program + new 31 CFR Part 502 OFAC compliance for permitted payment stablecoin issuers; richer NPRM-grounded spec with ISO 20022 fields + proposed CTR |
| **AUSTRAC Tranche 2 DNFBP example spec** (`austrac_tranche_2_dnfbp`) | v0.1.47 | AML/CTF Act 2006 — SMR + TTR for Australian DNFBPs; lawyers, accountants, real-estate agents, dealers in precious metals/stones now enforceable from July 1 |

These directly address the SR 26-2 and Effectiveness NPRM controls that are now examination-active (52 days from April 17): demonstrable test coverage of ML scoring logic, deterministic replay of flagged alerts, and a model inventory that can be produced on demand.
...
*Last updated: 2026-06-08 · Full chronological log: [2026-05-regulator-pulse.md](2026-05-regulator-pulse.md) — 2026-02-01 → 2026-05-31, 120 days, 33 events.*
