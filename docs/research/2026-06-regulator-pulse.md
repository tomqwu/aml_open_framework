...
**What it is:** AMLA must submit final draft regulatory technical standards — including the CDD information RTS (AMLR Art. 28(1)), the ongoing-monitoring-of-business-relationships RTS (AMLR Art. 26, CDD measure Art. 20(1)(f)), and the targeted-financial-sanctions screening RTS (AMLR Art. 20(1)(d)) — to the European Commission by July 10. After submission, the Commission has three months to endorse before the RTS become binding law. **36 days remain.**
