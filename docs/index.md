...
-   :material-book-open-variant:{ .lg .middle } **Researcher / regulator**
    ...
    Five July 2026 research editions now live: regulator-pulse, competitive-positioning, process-pain, fintech-aml-reality, data-problem. Deadline status (as of 2026-06-27): Effectiveness NPRM + GENIUS Act NPRM comment window **closed 2026-06-09** (rulemaking pending); AUSTRAC Tranche 2 **2026-07-01 — 4 days**; AMLA RTS **2026-07-10 — 13 days**; SR 26-2 **71 days** examination-active. M1–M4 ML roadmap shipped v0.1.46–v0.1.47.
...
|---------|-------|------|---------|
| `docs` | 38 | 2026-06-27 | June 27 docs refresh — deadline countdown updated to June 27 baseline: AUSTRAC Tranche 2 **4 days** (July 1 — imminent), AMLA RTS **13 days** (July 10), SR 26-2 **71 days** examination-active; all five July 2026 research editions synced. |
...
| `docs` | — | 2026-07-01 | July 2026 research refresh — all five editions carried forward to a 2026-07-01 as-of date: Effectiveness NPRM + GENIUS Act comment window **closed June 9** (rulemaking pending, no outcome asserted); AUSTRAC Tranche 2 enforcement live; AMLA RTS **10 days** (July 10); SR 26-2 **75 days** examination-active. |
