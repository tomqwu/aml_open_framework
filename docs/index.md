...
-   :material-book-open-variant:{ .lg .middle } **Researcher / regulator**
    ...
    Five July 2026 research editions pre-published; six June editions current. Deadline status (as of 2026-06-20): Effectiveness NPRM + GENIUS Act NPRM comment window **closed 2026-06-09** (rulemaking pending); AUSTRAC Tranche 2 **2026-07-01 — 11 days**; AMLA RTS **2026-07-10 — 20 days**; SR 26-2 **64 days** examination-active. M1–M4 ML roadmap shipped v0.1.46–v0.1.47.
...
|---------|-------|------|---------|
| `docs` | — | 2026-06-20 | June 2026 mid-month research refresh — June editions updated to post-June-9 state: Effectiveness NPRM + GENIUS Act comment window **closed June 9** (rulemaking pending); AUSTRAC Tranche 2 **11 days** (July 1); AMLA RTS **20 days** (July 10); SR 26-2 **64 days** examination-active. July 2026 research editions pre-published. |
| `docs` | — | 2026-07-01 | *(pre-published)* July 2026 research refresh — all five editions: Effectiveness NPRM + GENIUS Act comment window **closed June 9** (rulemaking pending); AUSTRAC Tranche 2 **effective July 1**; AMLA RTS **9 days** (July 10); SR 26-2 **75 days** examination-active. |
