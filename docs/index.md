...
-   :material-book-open-variant:{ .lg .middle } **Researcher / regulator**
    ...
    Five July 2026 research editions plus a new August 2026 data-problem edition now live. Deadline status (as of 2026-08-20): Effectiveness NPRM + GENIUS Act NPRM comment window **closed 2026-06-09** (rulemaking pending); AUSTRAC Tranche 2 **in effect since 2026-07-01** (50 days in; enrolment grace period **passed 2026-07-29**, 22 days ago; corporate penalty maximum corrected to **A$36.4M** at the current $364 penalty-unit value; AUSTRAC's first two enforcement actions of the window — Sportsbet finalised, bet365 fresh undertaking — landed against pre-existing wagering registrants, not new DNFBPs); AMLA RTS submission **deadline passed 2026-07-10** (41 days ago; Commission's 3-month endorsement clock now running to 2026-10-10, 51 days remaining); SR 26-2 **125 days** examination-active. M1–M4 ML roadmap shipped v0.1.46–v0.1.47.
...
|---------|-------|------|---------|
| `docs` | 55 | 2026-08-20 | August 20 docs refresh — merged Round 54 (#671) at the top of this run (draft since 2026-08-19, all 21 CI checks green, `mergeable_state: clean`) per #632's precedent, then built this refresh on the current baseline. Deadline countdown corrected to an August 20 baseline across all five `docs/research/2026-07-*.md` editions, `docs/index.md`'s deadline card, and the `docs/pitch/landing/` + `docs/pitch/landing/research/*.html` mirror pages (AUSTRAC Tranche 2 **50 days in**, was 49; enrolment grace period **passed 22 days ago**, was 21; AMLA RTS submission deadline **passed 41 days ago**, was 40; Commission endorsement clock **51 days remaining**, was 52; SR 26-2 **125 days** examination-active, was 124). The #668-tracked frozen "121 days, 33 events" instances were left untouched. Primary-source check, 2026-08-20: web search across all four tracked items found no new confirmed developments; also verified the AUSTRAC A$36.4M penalty figure ($364/unit) against AustLII's Crimes Act 1914 s4AA — still correct, a stale search snippet's $330/unit was the superseded 2025 rate. No new roadmap issue filed — #659/#668/#617/#632/#655 already cover the ground this round surfaced. `tomqwu/aml_open_framework_demo` needs no direct edit — it rebuilds automatically from `docs/**` on merge. |
