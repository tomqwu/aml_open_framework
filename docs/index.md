...
-   :material-book-open-variant:{ .lg .middle } **Researcher / regulator**
    ...
    Five July 2026 research editions now live: regulator-pulse, competitive-positioning, process-pain, fintech-aml-reality, data-problem. Deadline status (as of 2026-06-11): Effectiveness NPRM + GENIUS Act NPRM comment window **closed 2026-06-09** (rulemaking pending); AUSTRAC Tranche 2 **20 days** (July 1 — [go-live readiness how-to](how-to/austrac-tranche2-readiness.md)); AMLA RTS **29 days** (July 10); SR 26-2 **55 days** examination-active. M1–M4 ML roadmap shipped v0.1.46–v0.1.47.
...
|---------|-------|------|---------|
| `docs` | 37 | 2026-06-11 | Deadline refresh: AUSTRAC Tranche 2 **20 days**, AMLA RTS **29 days**, SR 26-2 **55 days** active. Two new how-tos: [AUSTRAC go-live readiness](how-to/austrac-tranche2-readiness.md) (closes #552) + [post-NPRM implementation planning](how-to/post-nprm-implementation-planning.md) (closes #551). Fixed DATA-N artifact map in all 4 data-problem editions (closes #548). Created April 2026 data-problem edition. |
