...
-   :material-book-open-variant:{ .lg .middle } **Researcher / regulator**
    ...
    Five July 2026 research editions now live: regulator-pulse, competitive-positioning, process-pain, fintech-aml-reality, data-problem. Deadline status (as of 2026-06-29): Effectiveness NPRM + GENIUS Act NPRM comment window **closed 2026-06-09** (rulemaking pending); AUSTRAC Tranche 2 **2026-07-01 — 2 days**; AMLA RTS **2026-07-10 — 11 days**; SR 26-2 **73 days** examination-active. M1–M4 ML roadmap shipped v0.1.46–v0.1.47.
...
|---------|-------|------|---------|
| `docs` | 38 | 2026-06-29 | June 29 docs refresh — deadline countdown corrected to June 29 baseline (AMLA RTS 11 days, AUSTRAC 2 days, SR 26-2 73 days); all five July 2026 research editions updated; 3 new roadmap GH issues filed (Getting Started AUSTRAC path, jurisdiction status API, SR 26-2 90-day milestone CLI). |
