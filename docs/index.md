...
-   :material-book-open-variant:{ .lg .middle } **Researcher / regulator**
    ...
    20 research editions live across 5 areas × 4 months (Apr–Jul 2026). July editions pre-dated to 2026-07-01; June edition patched 2026-06-10. **Deadline status (as of 2026-06-10):** Effectiveness NPRM + GENIUS Act NPRM comment window **closed 2026-06-09** — rulemaking pending (no final rule published); AUSTRAC Tranche 2 **2026-07-01 — 21 days**; AMLA RTS **2026-07-10 — 30 days**; SR 26-2 **54 days** examination-active. M1–M4 ML roadmap shipped v0.1.46–v0.1.47.
...
|---------|-------|------|---------|
| `docs` | — | 2026-06-10 | Deadline refresh (as of June 10): Both NPRMs closed Jun 9 (rulemaking pending, no final-rule outcome); AUSTRAC Tranche 2 **21 days** (Jul 1); AMLA RTS **30 days** (Jul 10); SR 26-2 **54 days** examination-active. June regulator-pulse patched. April data-problem archive completed. Artifact-map accuracy fixed (DATA-1/4/6) across all data-problem editions. |
| `docs` | — | 2026-07-01 | July 2026 research refresh — all five editions pre-dated to 2026-07-01 forward-looking as-of date: Effectiveness NPRM + GENIUS Act comment window **closed June 9** (rulemaking pending, no outcome asserted); AUSTRAC Tranche 2 **effective today (July 1)**; AMLA RTS **9 days** (July 10); SR 26-2 **75 days** examination-active. |
