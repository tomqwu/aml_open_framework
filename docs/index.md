...
-   :material-book-open-variant:{ .lg .middle } **Researcher / regulator**
    ...
    Five July 2026 research editions now live: regulator-pulse, competitive-positioning, process-pain, fintech-aml-reality, data-problem. Deadline status (as of 2026-07-13): Effectiveness NPRM + GENIUS Act NPRM comment window **closed 2026-06-09** (rulemaking pending); AUSTRAC Tranche 2 **in effect since 2026-07-01 — 12 days**; AMLA RTS submission deadline **passed 2026-07-10 — 3 days ago** (no outcome confirmed); SR 26-2 **87 days** examination-active. M1–M4 ML roadmap shipped v0.1.46–v0.1.47.
...
|---------|-------|------|---------|
| `docs` | 38 | 2026-07-13 | Mid-July docs refresh — all five July 2026 research editions + this page corrected to a 2026-07-13 as-of date: AUSTRAC Tranche 2 flipped from "9 days away" to **in effect, 12 days** (no enforcement actions publicly reported yet); AMLA RTS flipped from "18 days" to **deadline passed, 3 days ago** (no submission outcome confirmed); SR 26-2 examination-active count corrected 66→**87 days**. Pure day-count/status correction — no new citations, no fabricated outcomes. |
