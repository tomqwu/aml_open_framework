...
-   :material-book-open-variant:{ .lg .middle } **Researcher / regulator**
    ...
    Five July 2026 research editions plus a new August 2026 data-problem edition now live. Deadline status (as of 2026-08-10): Effectiveness NPRM + GENIUS Act NPRM comment window **closed 2026-06-09** (rulemaking pending); AUSTRAC Tranche 2 **in effect since 2026-07-01** (40 days in; enrolment grace period **passed 2026-07-29**, 12 days ago; corporate penalty maximum corrected to **A$36.4M** at the current $364 penalty-unit value; AUSTRAC's first two enforcement actions of the window — Sportsbet finalised, bet365 fresh undertaking — landed against pre-existing wagering registrants, not new DNFBPs); AMLA RTS submission **deadline passed 2026-07-10** (31 days ago; Commission's 3-month endorsement clock now running to 2026-10-10, 61 days remaining); SR 26-2 **115 days** examination-active. M1–M4 ML roadmap shipped v0.1.46–v0.1.47.
...
|---------|-------|------|---------|
| `docs` | 47 | 2026-08-10 | August 10 docs refresh — deadline countdown corrected to an August 10 baseline across all five `docs/research/2026-07-*.md` editions, `docs/index.md`'s deadline card, and the `docs/pitch/landing/` + `docs/pitch/landing/research/*.html` mirror pages (AUSTRAC Tranche 2 **40 days in**, was 39; enrolment grace period **passed 12 days ago**, was 11; AMLA RTS submission deadline **passed 31 days ago**, was 30; Commission endorsement clock **61 days remaining**, was 62; SR 26-2 **115 days** examination-active, was 114). Primary-source check, 2026-08-10: no new confirmed developments changing any tracked deadline/outcome since Round 46 — AUSTRAC's CEO reiterated in press commentary that non-enrolled conveyancers face "looming" action, which is supervisory posture, not a new enforcement action or compliance-rate outcome, so it isn't added as a tracked finding; the FinCEN Effectiveness NPRM and Whistleblower NPRM remain pending with no final rule; no independently verifiable press release confirms AMLA's RTS submission occurred. No new roadmap issue filed — #617, #632, #655, #659 already track the open work this round touches. |
