...
|---------|-------|------|---------|
| `docs` | 37 | 2026-06-09 | Round 37 docs refresh: April 2026 data-problem whitepaper added (completes 20-edition research archive, April–July); June 2026 regulator-pulse deadline marked ✓ closed (Effectiveness NPRM + GENIUS Act NPRM comment windows closed today); deadline countdown updated to live June 9 figures (AUSTRAC 22d, AMLA RTS 31d, SR 26-2 53d active). |
