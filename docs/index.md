...
-   :material-book-open-variant:{ .lg .middle } **Researcher / regulator**
    ...
    Five July 2026 research editions now live: regulator-pulse, competitive-positioning, process-pain, fintech-aml-reality, data-problem. Deadline status (as of 2026-07-09): Effectiveness NPRM + GENIUS Act NPRM comment window **closed 2026-06-09** (rulemaking pending); AUSTRAC Tranche 2 **enforcement active since 2026-07-01** (8 days in); AMLA RTS **2026-07-10 — 1 day**; SR 26-2 **83 days** examination-active. M1–M4 ML roadmap shipped v0.1.46–v0.1.47.
...
|---------|-------|------|---------|
| `docs` | 38 | 2026-07-09 | July 9 docs refresh — deadline countdown corrected to July 9 baseline across `docs/index.md` and all five `2026-07-*` research editions: AMLA RTS **1 day** (July 10), AUSTRAC Tranche 2 **enforcement active since July 1** (8 days in, was "9 days away"), SR 26-2 **83 days** examination-active (was 66). A stray "75 days" SR 26-2 mention in `competitive-positioning.md` (inconsistent with the doc's own June 22 baseline) corrected to match. |
