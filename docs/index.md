...
-   :material-book-open-variant:{ .lg .middle } **Researcher / regulator**
    ...
    Five July 2026 research editions now live: regulator-pulse, competitive-positioning, process-pain, fintech-aml-reality, data-problem. Deadline status (as of 2026-07-16): Effectiveness NPRM + GENIUS Act NPRM comment window **closed 2026-06-09** (rulemaking pending); AUSTRAC Tranche 2 **in effect since 2026-07-01** (15 days in); AMLA RTS submission **deadline passed 2026-07-10** (Commission's 3-month endorsement clock now running to 2026-10-10); SR 26-2 **90 days** examination-active. M1–M4 ML roadmap shipped v0.1.46–v0.1.47.
