...
-   :material-book-open-variant:{ .lg .middle } **Researcher / regulator**
    ...
    Five July 2026 research editions now live: regulator-pulse, competitive-positioning, process-pain, fintech-aml-reality, data-problem. Deadline status (as of 2026-07-02): Effectiveness NPRM + GENIUS Act NPRM comment window **closed 2026-06-09** (rulemaking pending); AUSTRAC Tranche 2 **enforcement began 2026-07-01 — now in effect**; AMLA RTS **2026-07-10 — 8 days**; SR 26-2 **76 days** examination-active. M1–M4 ML roadmap shipped v0.1.46–v0.1.47.
...
|---------|-------|------|---------|
| `docs` | 38 | 2026-07-02 | July 2 docs refresh — deadline countdown re-anchored to July 2 baseline (AUSTRAC Tranche 2 enforcement crossed from "9 days away" to **now in effect** July 1; AMLA RTS 8 days; SR 26-2 76 days examination-active) across all five July research editions + this page; `docs/dashboard-tour.md` Framework Alignment section documents the AMLA RTS coverage tab (closes #601); `README.md` surfaces `aml amla-effectiveness-report` + `aml whistleblower-audit` (closes #602); #600 closed as already-fixed by #529. |
