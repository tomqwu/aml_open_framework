...
-   :material-book-open-variant:{ .lg .middle } **Researcher / regulator**
    ...
    Five July 2026 research editions plus a new August 2026 data-problem edition now live. Deadline status (as of 2026-08-11): Effectiveness NPRM + GENIUS Act NPRM comment window **closed 2026-06-09** (rulemaking pending); AUSTRAC Tranche 2 **in effect since 2026-07-01** (41 days in; enrolment grace period **passed 2026-07-29**, 13 days ago; corporate penalty maximum confirmed at **A$36.4M** at the current $364 penalty-unit value; AUSTRAC's first two enforcement actions of the window — Sportsbet finalised, bet365 fresh undertaking — landed against pre-existing wagering registrants, not new DNFBPs); AMLA RTS submission **deadline passed 2026-07-10** (32 days ago; Commission's 3-month endorsement clock now running to 2026-10-10, 60 days remaining); SR 26-2 **116 days** examination-active. M1–M4 ML roadmap shipped v0.1.46–v0.1.47.
...
|---------|-------|------|---------|
| `docs` | 47 | 2026-08-11 | August 11 docs refresh — deadline countdown corrected to an August 11 baseline across all five `docs/research/2026-07-*.md` editions, `docs/index.md`'s deadline card, and the `docs/pitch/landing/` + `docs/pitch/landing/research/*.html` mirror pages (AUSTRAC Tranche 2 **41 days in**, was 39; enrolment grace period **passed 13 days ago**, was 11; AMLA RTS submission deadline **passed 32 days ago**, was 30; Commission endorsement clock **60 days remaining**, was 62; SR 26-2 **116 days** examination-active, was 114). Primary-source check, 2026-08-11: web search against AUSTRAC, AMLA, and FinCEN sources found no new confirmed developments on any of the four tracked items since Round 46; independently re-verified the AUSTRAC A$364 penalty-unit figure (Round 43's correction) against the Crimes Act 1914 s.4AA July-2026 indexation — still correct, no change needed. No new roadmap issue filed — #659, #655, #632, #617 already track the open work this round touches; the open-issue list stands at 70, reinforcing #644's anti-pile-up guidance. |
