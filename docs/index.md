...
-   :material-book-open-variant:{ .lg .middle } **Researcher / regulator**
    ...
    Five July 2026 research editions now live: regulator-pulse, competitive-positioning, process-pain, fintech-aml-reality, data-problem. Deadline status (as of 2026-06-24): Effectiveness NPRM + GENIUS Act NPRM comment window **closed 2026-06-09** (rulemaking pending); AUSTRAC Tranche 2 **2026-07-01 — 7 days**; AMLA RTS **2026-07-10 — 16 days**; SR 26-2 **68 days** examination-active. M1–M4 ML roadmap shipped v0.1.46–v0.1.47.
...
|---------|-------|------|---------|
| `docs` | 38 | 2026-06-24 | June 24 deadline refresh — all five July 2026 research editions updated to June 24 baseline: AUSTRAC 7 days (July 1), AMLA RTS 16 days (July 10), SR 26-2 68 days examination-active. 3 new GitHub roadmap issues filed (#608 research-deadline refresher script, #609 September 2026 research refresh, #610 `aml compliance-calendar export`). |
