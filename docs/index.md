...
-   :material-book-open-variant:{ .lg .middle } **Researcher / regulator**
    ...
    Five July 2026 research editions now live: regulator-pulse, competitive-positioning, process-pain, fintech-aml-reality, data-problem. Deadline status (as of 2026-07-31): Effectiveness NPRM + GENIUS Act NPRM comment window **closed 2026-06-09** (rulemaking pending); AUSTRAC Tranche 2 **in effect since 2026-07-01** (30 days in; enrolment grace period **ended 2026-07-29**, 2 days ago); AMLA RTS submission **deadline passed 2026-07-10** (21 days ago; Commission's 3-month endorsement clock now running to 2026-10-10); SR 26-2 **105 days** examination-active. M1–M4 ML roadmap shipped v0.1.46–v0.1.47.
...
|---------|-------|------|---------|
| `docs` | 42 | 2026-07-31 | July 31 docs refresh — deadline countdown corrected to July 31 baseline (AUSTRAC Tranche 2 **30 days in**, was 23; enrolment grace period **ended 2026-07-29** — 2 days ago, reframed from a countdown now that it has passed; AMLA RTS submission deadline **passed 21 days ago**, was 14; SR 26-2 **105 days** examination-active, was 98); merge gate simplification from #650 (Codex review no longer required) lets this round merge directly instead of stacking another draft PR. |
