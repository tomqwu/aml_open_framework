...
class TestEUSpec:
    def test_eu_spec_validates(self):
        ...
        # PR-ML-3 added the investment_scam_scorer python_ref
        # amplifier alongside the SQL aggregation_window rule.
        ...
        assert any(r.id == "investment_scam_scorer" for r in spec.rules)
