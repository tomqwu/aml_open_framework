...
Full catalogue (`aml api`, `typology-*`, `backtest`, `replay`, `amla-effectiveness-report`, `whistleblower-audit`, `defect-update`): [`docs/getting-started.md`](docs/getting-started.md#stage-0-warm-up-2-minute-sanity-check). Sources: `synthetic` (default), `csv`, `parquet`, `duckdb`, `iso20022`, `s3`, `gcs`, `snowflake`, `bigquery`.
