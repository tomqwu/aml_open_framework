...
| 📊 [Dashboard Tour](docs/dashboard-tour.md) | All 40 pages (32 operational + 8 Knowledge research briefs) with screenshots (partial coverage) + audience filtering — incl. GenAI assistant on every page |
...
| 📡 [Regulator Pulse — Feb–May 2026](docs/research/2026-05-regulator-pulse.md) | 97-day rolling log of AML/sanctions regulator actions — 31 events, primary-source only |
...
src/aml_framework/
  ...
  dashboard/                    Streamlit web dashboard (40 pages: 32 operational + 8 Knowledge, persona-aware, GenAI co-pilot)
